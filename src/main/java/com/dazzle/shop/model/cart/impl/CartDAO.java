...
public class CartDAO {
	...
	private final String CART_LIST = "SELECT c.cart_num, c.user_num, pimg.main_img, c.product_code, p.product_price, (p.product_price * c.amount) AS total_price, c.amount, p.product_name, pco.color_name, ps.size_name"
