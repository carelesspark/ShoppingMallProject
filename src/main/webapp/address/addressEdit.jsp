        ...
        <form action="addressEdit.do" method="post">
		    ...
		    <div>
		        ...
		        <div class="marg">
		            ...
		            <div id="addr"><input class="full" id="address" name="address" value="<c:out value='${address.address}'/>"></div>
		            <div id="detailAddr"><input class="full" id="detail_address" name="detail_address" value="<c:out value='${address.detail_address}'/>"></div>
		        </div>
		        <div class="marg">
		            배송 메시지
