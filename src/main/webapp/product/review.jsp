      ...
      <div class="row">
         <div class="col-md-8 offset-md-2">
            <div class="content-box">
               <form action="/submit_review.do"  method="post" enctype="multipart/form-data" name="form">
                  ...
                  <button type="button" class="btn btn-submit mt-3" onclick="checkAgreement()">리뷰 등록</button>
               </form>
            </div>
         </div>
      </div>
