			...
			<main>
				<div id="md">
					...
					<div id="lr">
						...
						<div id="lrc">
							<form action="/user/changeInquiryList.do"
						...
						<div id="pBtn">
							<div id="prevbb">
								<button type="button" id="prevb"
									<c:if test="${currentPage > 1}">onclick="window.location.href='/user/changeInquiryList.do?sDate=${startDate}&eDate=${endDate}&currentPage=${currentPage - 1}&itemsPerPage=${itemsPerPage}'"</c:if>>&lt;</button>
							</div>
							<div id="pShow">
								<div>${currentPage}</div>
								<div>&nbsp/&nbsp</div>
							...
							<div id="nextbb">
								<button type="button" id="nextb"
									<c:if test="${currentPage < totalPage}">onclick="window.location.href='/user/changeInquiryList.do?sDate=${startDate}&eDate=${endDate}&currentPage=${currentPage + 1}&itemsPerPage=${itemsPerPage}'"</c:if>>&gt;</button>
							</div>
						</div>
						<div id="pSize">
							...
							<div id="psbb">
								...
								<div id="psbb1">
									<button type="button"
										onclick="window.location.href='/user/changeInquiryList.do?sDate=${startDate}&eDate=${endDate}&currentPage=1&itemsPerPage=10'">10</button>
								</div>
								<div id="psbb2">
									<button type="button"
										onclick="window.location.href='/user/changeInquiryList.do?sDate=${startDate}&eDate=${endDate}&currentPage=1&itemsPerPage=20'">20</button>
								</div>
								<div id="psbb3">
									<button type="button"
										onclick="window.location.href='/user/changeInquiryList.do?sDate=${startDate}&eDate=${endDate}&currentPage=1&itemsPerPage=30'">30</button>
								</div>
							</div>
