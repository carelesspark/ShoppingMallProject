...
<link href="../resources/css/order/orderInfoEdit.css" rel="stylesheet" />
<link rel="stylesheet"
					...
					<div id="bottom_buttons">
						<div id="bottom_button_div1">
							<button type="button" class="btn btn-outline-secondary"
								id="button3" onclick="location.href='/order/orderInfoAdmin.jsp'">저장하기</button>
						</div>
						<div>
							<button type="button" class="btn btn-outline-secondary"
								id="button4" onclick="location.href='/order/orderListAdmin.jsp'">목록</button>
						</div>
					</div>
				</div>
			</main>
